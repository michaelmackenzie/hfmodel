...
def convert_zfit_parameter_to_roofit(param: Any, roo_name: Optional[str] = None, cache: Optional[Dict[str, Any]] = None):
    ...
    formula_meta = getattr(param, "_hfmodel_rooformula", None)
...
def _build_parser():
    parser = argparse.ArgumentParser(
        description=(
            ...
            "usable by hfmodel card 'shapes' lines, or export a zfit analysis snapshot back to ROOT."
        )
    )
